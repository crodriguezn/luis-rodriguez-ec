...
class Helper_Validacion 
{
    static public function tieneEspacios( $var )
    {
    ...
    static public function validarRucPersonaNatural($numero = '') 
    {
        ...
        try
        {
            ...
            self::validarCodigoEstablecimiento(substr($numero, 10, 3));
            self::algoritmoModulo10(substr($numero, 0, 9), $numero[9]);
        } 
        catch (Exception $e)
        {
     ...
     */
    static public function validarCodigoEstablecimiento($numero)
    {
        if ($numero < 1)
        {
